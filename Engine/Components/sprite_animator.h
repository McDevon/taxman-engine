...
typedef struct Animator {
    ...
    void (*completion_callback)(void *obj, void *context);
...
void animator_set_animation_count(Animator *comp, const char *animation_name, int32_t repeat_count, void (*completion_callback)(void *obj, void *context), void *context);
