...
Float pbd_left(PhysicsBody *physics_body);
Float pbd_right(PhysicsBody *physics_body);
Float pbd_top(PhysicsBody *physics_body);
Float pbd_bottom(PhysicsBody *physics_body);
